...
\begin{adjustwidth}{}{-10cm}
    \cvsection{Education}
    \cvblock{Ph.D. in Computer Science}{University of Bologna}{2023--2026}{Cesena, Italy}
    \textbf{Supervisor: Danilo Pianini} \newline \textbf{Co-Supervisor: Mirko Viroli}

    \divider 

    \cvblock{Visiting Researcher}{University of Toulouse Paul Sabatier}{02-05/2026}{Toulouse, France}
    \textbf{Supervisor: Elsy Kaddoum}

    \divider

    \cvblock{Visiting Researcher}{University of Kiel}{01-03/2025}{Kiel, Germany}
    \textbf{Supervisor: Sven Tomforde}
...
\begin{adjustwidth}{}{-10cm}
    ...
    % \section{Accepted}
    % Currently: COORDINATION 26 Unity, Coordination 25 Journal
    \nocite{*}
...
\begin{adjustwidth}{}{-10cm}
    ...
    \cvblock{Phd Track Special Mention}{EUMAS 2023 {\newline \scriptsize20th European Conference of Multi-Agent Systems}}{15 Sep 2023}{Naples, Italy}
    ...
    \cvblock{Best Poster Award}{ACSOS 2024 {\newline \scriptsize 5th IEEE International Conference on Autonomic Computing and Self-Organizing Systems}}{20 Sep 2024}{Aarhus, Denmark}

    \divider

    \cvblock{Best Student Paper Award}{ACSOS 2025 {\newline \scriptsize 6th IEEE International Conference on Autonomic Computing and Self-Organizing Systems}}{20 Sep 2025}{Tokyo, Japan}
...
\begin{adjustwidth}{}{-10cm}
    ...
    \cvblockActivities{}{Student Volunteers Chair}{2026}{ACSOS (IEEE International Conference on Autonomic Computing and Self-Organizing Systems)}

    \cvblockActivities{}{Artifact Evaluation Committee}{2025}{SIGSIM PADS (Principles of Advanced Discrete Simulation)}
    \cvblockActivities{}{Artifact Evaluation Committee}{2025}{ECOOP (European Conference on Object-Oriented Programming)}

    \cvblockActivities{}{Artifact Evaluation Committee}{2024}{SLE (Software Language Engineering)}

\end{adjustwidth}

\begin{adjustwidth}{}{-10cm}
    \cvsection{Research Contracts}
    \cvblock{\textbf{Research Fellowship} {\newline \footnotesize ``Systems, tools, and methodologies for deploying and updating industrial software in the cloud-edge continuum''}}{DISI - University of Bologna}{07-10/2023}{Cesena, Italy}
    \textbf{Supervisor: Danilo Pianini}
...
\begin{adjustwidth}{}{-10cm}
    ...
    \cvblock{Tutor for the course \\ ``Object-Oriented Programming''}{DISI - Laurea in Ingegneria e Scienze Informatiche \newline University of Bologna}{A.Y. 2022/2023, \newline A.Y. 2023/2024, \newline A.Y. 2024/2025, \newline A.Y. 2025/2026}{Cesena, Italy}
    \textbf{Supervisor: Mirko Viroli}

    \divider

    \cvblock{Tutor for the course ``Virtualised Systems''}{DISI - Laurea in Tecnologie dei Sistemi Informatici \newline University of Bologna}{A.Y. 2021/2022, \newline A.Y. 2022/2023}{Cesena, Italy}
    \textbf{Supervisor: Vittorio Ghini}
